...
Esnek bir kıkırdağa ihtiyacımız var ise kulak kıkırdağı, daha sert ve miktar olarak fazla kıkırdağa ihtiyacımız var ise kaburga (kosta) kıkırdağı kullanılmaktadır.

Kıkırdak graft kullanma gerekliliği ve gerekli ise hangisinin kullanılması gerektiği muayene sırasında size anlatılacaktır. 
Bazı durumlarda kıkırdak alma gerekliliği kesin bazı durumlarda ise olasıdır. 
        ...
        content: [
          {
            ...
            text: `The nose is a functional organ located in the very center of the face. 
The functional task of the nose is to breathe and smell, and its visual task is to ensure the face looks beautiful.
The nose must fully perform its functional duties and must be in harmony and proportion with other organs on the face. 
In addition, it should be symmetrical and pleasing to the eye.
...
Due to healing delay, the risk of infection in the nose increases, stitches opening, increased edema in the nose and the risk of the desired result resulting differently than expected and badly due to delayed healing occurs.
    ...
    tabs: [
      {
        ...
        content: [
          {
            title: "Was ist eine Nasenkorrektur (Rhinoplastik)?",
            text: `Die Nase ist ein funktionelles Organ, das sich genau in der Mitte des Gesichts befindet. 
Die funktionelle Aufgabe der Nase ist das Atmen und Riechen, und ihre visuelle Aufgabe ist es, dafür zu sorgen, dass das Gesicht schön aussieht.
Die Nase muss ihre funktionellen Aufgaben vollständig erfüllen und in Harmonie und Proportion mit anderen Organen im Gesicht stehen. 
Außerdem sollte sie symmetrisch und angenehm für das Auge sein.
...
Aufgrund der Heilungsverzögerung steigt das Infektionsrisiko in der Nase, das Öffnen der Nähte, ein erhöhtes Ödem in der Nase und das Risiko, dass das gewünschte Ergebnis anders als erwartet und schlecht aufgrund einer verzögerten Heilung ausfällt.
        ...
        content: [
          {
            ...
            text: `La nariz es un órgano funcional ubicado en el centro mismo de la cara. 
La tarea funcional de la nariz es respirar y oler, y su tarea visual es asegurar que la cara se vea hermosa.
La nariz debe cumplir plenamente con sus deberes funcionales y debe estar en armonía y proporción con otros órganos de la cara. 
Además, debe ser simétrica y agradable a la vista.
        ...
        content: [
          {
            ...
            text: `Al final de la cirugía, habrá puntos finos estéticos en el sitio de la incisión en la piel entre las fosas nasales (columela), un stent/tapón con un orificio en el interior que no le impide respirar dentro de la nariz, y una cinta especial y una férula de plástico (yeso) en la nariz. Si se han intervenido las alas nasales, también habrá puntos en la parte del ala nasal.

Retirada del tapón y yeso: El tapón, la cinta y la férula en la nariz se retirarán en el control en la primera semana (5-7 días) de su cirugía. (En algunos casos, el tapón dentro de la nariz se puede retirar antes).
...
Hematomas e hinchazón debajo de los ojos: En los casos en que se realiza una intervención ósea en su cirugía, habrá algo de hinchazón y hematomas alrededor de la nariz y debajo de los ojos. Esta situación alcanza su máximo en el 3er-4to día después de la cirugía. 
...
* En el siguiente período de aproximadamente 2-3 meses, el edema especialmente en el dorso, la punta y las partes laterales de las alas de la nariz disminuirá gradualmente con el tiempo y aproximadamente el 70% del edema pasará. 
* Se requerirá aproximadamente 1-1.5 años más de tiempo para el 30% restante. 
...
En algunas técnicas quirúrgicas utilizadas, debido al asentamiento y cierto aflojamiento de los cartílagos y puntos con el tiempo y con el efecto de la gravedad, puede haber algún movimiento hacia abajo en la punta nasal en el período de 4-6 semanas después de la cirugía. Debido a esta situación, su punta nasal puede estar un poco respingona en el período temprano después de la cirugía. (no válido para todos los pacientes).

Evitar Fuerzas Físicas en la Nariz:
Su nariz no debe estar expuesta a una fuerza física incontrolada durante 4 meses después de la cirugía. Los problemas que pueden ocurrir en este período cuando la fusión ósea aún no se ha completado pueden crear problemas permanentes en la curación de la nariz. En este período de 4 meses, debe evitar actividades que puedan crear trauma nasal y no debe usar gafas. 
...
Deportes/Ejercicio: 
Se pueden realizar actividades deportivas leves que no causen aumento del pulso a partir de la 2ª semana después de la cirugía. 
...
Debido al retraso en la curación, aumenta el riesgo de infección en la nariz, apertura de puntos, aumento del edema en la nariz y el riesgo de que el resultado deseado resulte diferente de lo esperado y mal debido a la curación retrasada.
...
Si tiene un riesgo adicional al estándar con respecto a la anestesia, se le informará por separado.
        ...
        content: [
          {
            ...
            text: `Нос - это функциональный орган, расположенный в самом центре лица. 
Функциональная задача носа - дышать и обонять, а его визуальная задача - обеспечивать красоту лица.
Нос должен полностью выполнять свои функциональные обязанности и находиться в гармонии и пропорции с другими органами лица. 
Кроме того, он должен быть симметричным и приятным для глаз.

Цель операции ринопластики (септоринопластики) - придать носу функциональную и эстетическую красоту.`
          },
          {
            title: "ЦЕЛЬ ОПЕРАЦИИ",
            text: `Цель операции ринопластики - получить внешний вид носа, который сделает пациента счастливым, предложив решение проблем в носу пациента, а также обеспечив комфортное дыхание.
Поскольку проблема в каждом носу разная, процедуры, которые будут применяться, также различаются. Процедуры, которые могут быть выполнены на вашем носу, и возможные результаты, которые могут быть получены, будут сообщены вам устно во время осмотра.

Операция проводится по решению, принятому двусторонне.
    * Как пациент должен хотеть, чтобы его оперировал врач, так и врач должен выполнять операцию, полагая, что она принесет пользу пациенту.
    * Поэтому предоперационное обследование и оценка должны проводиться в правильное время и в правильных условиях. 
...
В этой технике делается разрез на коже между ноздрями, и этот разрез зашивается в конце операции в соответствии с эстетической целью.`
      ...
      },
      {
        ...
        content: [
          {
            title: "ФОТОГРАФИЯ",
            text: `Фотографирование проводится до, во время и после операции. Предоперационное фотографирование является частью осмотра.
Цель фотографирования - понять, объяснить и запомнить проблемы в носу и использовать объективные данные при планировании операции.

Симуляция не проводится на фото после фотографирования.
Нет необходимости в симуляции у пациентов, которые могут объяснить, что они требуют, и их понимают.

Пациенты, которые думают, что не могут полностью выразить словесно, какой нос они хотят, могут показать фотографии носа, которые им нравятся, во время осмотра и отправить их для добавления в карту пациента. 

Пациенты, которые хотят представить гармонию возможных изменений в носу с их лицом, могут смоделировать свои собственные фотографии и поделиться своими требованиями с врачом таким образом.
Фотографии, показанные пациентом, не должны восприниматься как заказ. Это инструмент для человека, чтобы объяснить стиль, который ему нравится, и его запрос. Эту информацию определенно не следует забывать.
        ...
        content: [
          {
            ...
            text: `Le nez est un organe fonctionnel situé au centre même du visage. 
La tâche fonctionnelle du nez est de respirer et de sentir, et sa tâche visuelle est d'assurer la beauté du visage.
Le nez doit remplir complètement ses fonctions fonctionnelles et être en harmonie et en proportion avec les autres organes du visage. 
De plus, il doit être symétrique et agréable à l'œil.

Le but de la chirurgie de rhinoplastie (septorhinoplastie) est d'apporter une beauté fonctionnelle et esthétique au nez.`
          },
          {
            title: "BUT DE LA CHIRURGIE",
            text: `Le but de la chirurgie de rhinoplastie est d'obtenir une apparence nasale qui rendra le patient heureux en offrant une solution aux problèmes du nez du patient ainsi qu'une respiration confortable.
Comme le problème dans chaque nez est différent, les procédures à appliquer diffèrent également. Les procédures qui peuvent être effectuées sur votre nez et les résultats possibles qui peuvent être obtenus vous seront communiqués verbalement lors de l'examen.

La chirurgie est réalisée sur une décision prise bilatéralement.
    * Tout comme le patient doit vouloir être opéré par le médecin, le médecin doit effectuer l'opération en croyant qu'elle sera bénéfique pour le patient.
    ...
    * La probabilité qu'une opération non souhaitée par l'une des deux parties se termine heureusement est assez faible.`
          },
          {
...
Dans cette technique, une incision est pratiquée sur la peau entre les narines, et cette incision est suturée à la fin de la chirurgie conformément à l'objectif esthétique.`
      ...
      },
      {
        ...
        content: [
          {
            title: "PHOTOGRAPHIE",
            text: `La photographie est réalisée avant, pendant et après la chirurgie. La photographie préopératoire fait partie de l'examen.
Le but de la photographie est de comprendre, d'expliquer et de se souvenir des problèmes du nez et d'utiliser des données objectives lors de la planification de la chirurgie.

La simulation n'est pas effectuée sur la photo après la photographie.
...
Les patients qui pensent ne pas pouvoir exprimer complètement verbalement le nez qu'ils souhaitent peuvent montrer des photos de nez qu'ils aiment lors de l'examen et les envoyer pour qu'elles soient ajoutées au dossier du patient. 

Les patients qui souhaitent imaginer l'harmonie des changements possibles dans leur nez avec leur visage peuvent simuler leurs propres photos et partager leurs demandes avec le médecin de cette manière.
Les photos montrées par le patient ne doivent pas être perçues comme une commande. C'est un outil pour que la personne explique le style qu'elle aime et sa demande. Cette information ne doit absolument pas être oubliée.
Il n'est pas réaliste de dessiner exactement quel résultat sera obtenu à la fin de la guérison sur la photo après la chirurgie.`
          }
        ]
      },
      {
        ...
        content: [
          {
            ...
            text: `Il naso è un organo funzionale situato proprio al centro del viso. 
Il compito funzionale del naso è respirare e odorare, e il suo compito visivo è garantire la bellezza del viso.
Il naso deve adempiere completamente ai suoi doveri funzionali ed essere in armonia e proporzione con gli altri organi del viso. 
Inoltre, deve essere simmetrico e piacevole alla vista.

Lo scopo della chirurgia di rinoplastica (settorinoplastica) è conferire al naso una bellezza funzionale ed estetica.`
          },
          {
            title: "SCOPO DELL'INTERVENTO",
            text: `Lo scopo della chirurgia di rinoplastica è ottenere un aspetto nasale che renda felice il paziente offrendo una soluzione ai problemi del naso del paziente e una respirazione confortevole.
Poiché il problema in ogni naso è diverso, anche le procedure da applicare differiscono. Le procedure che possono essere eseguite sul tuo naso e i possibili risultati che possono essere ottenuti ti saranno comunicati verbalmente durante l'esame.

L'intervento chirurgico viene eseguito su decisione presa bilateralmente.
    * Proprio come il paziente deve voler essere operato dal medico, il medico deve eseguire l'operazione credendo che sarà vantaggiosa per il paziente.
    * Pertanto, l'esame e la valutazione preoperatori devono essere eseguiti al momento giusto e nelle giuste condizioni. 
    * La probabilità che un'operazione non voluta da una delle due parti finisca felicemente è piuttosto bassa.`
          },
          {
...
In questa tecnica, viene praticata un'incisione sulla pelle tra le narici e questa incisione viene suturata alla fine dell'intervento in conformità con l'obiettivo estetico.`
      ...
      },
      {
        ...
        content: [
          {
            title: "FOTOGRAFIA",
            text: `La fotografia viene eseguita prima, durante e dopo l'intervento chirurgico. La fotografia preoperatoria fa parte dell'esame.
Lo scopo della fotografia è comprendere, spiegare e ricordare i problemi del naso e utilizzare dati oggettivi durante la pianificazione dell'intervento chirurgico.
...
Non è realistico disegnare esattamente quale risultato si otterrà alla fine della guarigione sulla foto dopo l'intervento chirurgico.`
          }
        ]
      },
      {
        ...
        content: [
          {
            ...
            text: `Nasul este un organ funcțional situat chiar în centrul feței. 
Sarcina funcțională a nasului este de a respira și de a mirosi, iar sarcina sa vizuală este de a asigura frumusețea feței.
Nasul trebuie să își îndeplinească complet sarcinile funcționale și să fie în armonie și proporție cu celelalte organe ale feței. 
În plus, trebuie să fie simetric și plăcut ochiului.

Scopul operației de rinoplastie (septorinoplastie) este de a conferi nasului o frumusețe funcțională și estetică.`
          },
          {
            title: "SCOPUL OPERAȚIEI",
            text: `Scopul operației de rinoplastie este de a obține un aspect nazal care să facă pacientul fericit, oferind o soluție la problemele nasului pacientului, precum și o respirație confortabilă.
Deoarece problema fiecărui nas este diferită, procedurile care trebuie aplicate diferă, de asemenea. Procedurile care pot fi efectuate asupra nasului dumneavoastră și rezultatele posibile care pot fi obținute vă vor fi comunicate verbal în timpul examinării.

Operația se efectuează pe baza unei decizii luate bilateral.
    * Așa cum pacientul trebuie să dorească să fie operat de medic, medicul trebuie să efectueze operația crezând că aceasta va fi benefică pentru pacient.
    * Prin urmare, examinarea și evaluarea preoperatorie trebuie efectuate la momentul potrivit și în condițiile potrivite. 
    * Probabilitatea ca o operație nedorită de una dintre cele două părți să se încheie cu fericire este destul de mică.`
          },
          {
...
În această tehnică, se face o incizie pe pielea dintre nări, iar această incizie este suturată la sfârșitul operației în conformitate cu scopul estetic.`
      ...
      },
      {
        ...
        content: [
          {
            title: "FOTOGRAFIE",
            text: `Fotografierea se realizează înainte, în timpul și după operație. Fotografierea preoperatorie face parte din examinare.
...
Simularea nu se efectuează pe fotografie după fotografiere.
Nu este necesar să se facă o simulare la pacienții care pot explica ce doresc și sunt înțeleși.

Pacienții care cred că nu pot exprima complet în cuvinte nasul pe care și-l doresc pot arăta fotografii cu nasuri care le plac în timpul examinării și le pot trimite pentru a fi adăugate la dosarul pacientului. 

Pacienții care doresc să își imagineze armonia posibilelor schimbări ale nasului lor cu fața lor pot simula propriile fotografii și pot împărtăși cererile lor cu medicul în acest fel.
Fotografiile arătate de pacient nu trebuie percepute ca o comandă. Este un instrument pentru ca persoana să explice stilul care îi place și cererea sa. Această informație nu trebuie uitată absolut deloc.
Nu este realist să se deseneze exact ce rezultat se va obține la sfârșitul vindecării pe fotografie după operație.`
          }
        ]
      },
      {
