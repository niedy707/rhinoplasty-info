...
function AppContent() {
  ...
  const footerTranslations = {
    ...
    ar: {
      title: "تجميل الأنف",
      country: "تركيا",
      appointment: "للأسئلة الطبية فقط",
      agencyLabel: "لجميع الاستفسارات والتخطيط",
      note: <i>يتعاون الجراح مع <span style={{ backgroundColor: '#3b82f6', color: 'white', padding: '0 4px', borderRadius: '2px' }}>وكالة ميدبروبر للسياحة العلاجية.</span></i>
    }
  };
      ...
      <main className="tab-content">
        {activeTabId === 'tab8' ? (
          <FAQSection
            data={activeTab}
            lang={lang}
            searchPlaceholder={currentContent.searchPlaceholder}
          />
        ) : activeTabId === 'tab9' ? (
